...
import com.example.server.Handlers.ClearHandler;
import com.example.server.Handlers.DefaultHandler;
import com.example.server.Handlers.EventHandler;
import com.example.server.Handlers.FillHandler;
import com.example.server.Handlers.LoadHandler;
import com.example.server.Handlers.LoginHandler;
import com.example.server.Handlers.PersonHandler;
import com.example.server.Handlers.RegisterHandler;
...
public class FamilyMapServer {
    ...
    public static void main(String[] args) {
        ...
        new FamilyMapServer().run(portNumber);
    }
}
